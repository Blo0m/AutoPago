...
public class ResultResourceFromEntityAssembler {
    public static ResultResource toResourceFromEntity(Result entity) {
        return new ResultResource(entity.getId(), entity.getN(), entity.getGraceType(), entity.getCok(), entity.getInterest(), entity.getLifeInsurance(), entity.getFee(), entity.getAmortization(),
